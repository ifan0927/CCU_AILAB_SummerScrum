        ...
        <div>
            <form>
                <div>系統選擇:
                    ...
                    標題:<input><br>
                    內容:<textarea></textarea><br>
                    選擇檔案:<input type="file"><br>
                    新增連結:<input type="url"><br>
                    上架時間:<input type="date"><br>
                    下架時間:<input type="date"><br>
                </div>
            </form>
            ...
            <div id="dialog" class="dialog">
                ...
                <a href="index.php"><button class="btn btn-info">確定送出</button></a>
            </div>
