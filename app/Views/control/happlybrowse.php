...
<div class="container" style="padding-top:75px">
    <ul class="nav nav-pills justify-content-center">
        ...
        <li class="nav-item">
            <a class="nav-link active" href="/ControlController/happlybrowse/1">高中申請</a>
        </li>
    </ul>
</div>
                        ...
                        <div class="modal" tabindex="-1" id="modal'.$rowcount.'"  aria-hidden="true" >
                            <div class="modal-dialog">
                                ...
                                <div class="modal-footer">
                                    ...
                                    <a href="/ControlController/delete/4/'.$posts_item['id'].'"><button type="button" class="btn btn-primary">刪除</button></a>
                                </div>
                                </div>
                            </div>
                        </div>
    ...
    <nav aria-label="Page navigation example">
        <ul class="pagination justify-content-center">
            <?php
                ...
                for ($i = 0 ; $i < $p ; $i++){
                    echo'
                    <li class="page-item"><a class="page-link" href="/ControlController/happlybrowse/'.$pagecount.'">'.$pagecount.'</a></li>
                    ';
                    $pagecount ++;
                }
            ?>
