...
<div class="container" style="padding-top:75px">
    <ul class="nav nav-pills justify-content-center">
        <li class="nav-item">
            <a class="nav-link active" aria-current="page" href="/ControlController/ustarbrowse/1">大學繁星</a>
        </li>
        <li class="nav-item">
            <a class="nav-link" href="/ControlController/hstarbrowse/1">高中繁星</a>
        </li>
        <li class="nav-item">
                        ...
                        <div class="modal" tabindex="-1" id="modal'.$rowcount.'"  aria-hidden="true" >
                            <div class="modal-dialog">
                                ...
                                <div class="modal-footer">
                                    ...
                                    <a href="/ControlController/delete/1/'.$posts_item['id'].'"><button type="button" class="btn btn-primary">刪除</button></a>
                                </div>
                                </div>
                            </div>
                        </div>
    ...
    <nav aria-label="Page navigation example">
        <ul class="pagination justify-content-center">
            <?php
                ...
                for ($i = 0 ; $i < $p ; $i++){
                    echo'
                    <li class="page-item"><a class="page-link" href="/ControlController/ustarbrowse/'.$pagecount.'">'.$pagecount.'</a></li>
                    ';
                    $pagecount ++;
                }
            ?>
